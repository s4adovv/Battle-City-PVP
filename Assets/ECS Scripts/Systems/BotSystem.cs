...
public sealed class BotSystem : UpdateSystem
{
	...
	public override void OnUpdate(float deltaTime) {
		...
		for (int i = 0; i < Only_Bots_Filter.Length; i++) {
			...
			if (botTeamComponent.Team != PlayManager.frozenTeam) {
				MoveAI(ref botGameObjectComponent, ref botTankComponent, ref botTeamComponent, ref botComponent);
			}
		}
	}
	...
	/// </summary>
	private void MoveAI(ref GameObjectComponent botGameObjectComponent, ref TankComponent botTankComponent, ref TeamComponent botTeamComponent, ref BotComponent botComponent) {
